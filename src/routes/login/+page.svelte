    ...
    <div class="login-container">
        ...
        <form action="?/login" class="form" method="POST" use:enhance>
            ...
            <div class="email-input-container">
                <input type="email" class="email-input" placeholder="username@gmail.com" name="email" value={form?.email ?? ""}>
            </div>
            ...
            <p class="no-account">Don't have an account yet? <a href="/signup">Register for free</a></p>
        </form>
